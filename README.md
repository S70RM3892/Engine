...
- **ENGINE EMPIRE**: 同じ物理エンジンで動く育成ゲーム (**別アプリ** `com.s70rm3892.engineempire`)。昼はシフト (ダイナモで稼ぐ・エンジン特性から作られる依頼・熱と耐久・日替わりイベント)、夜はガレージ (強化ボード・チューン・仕様・エンジンツリー・目標) のサイクルで、限られた ¥ と ★ の使い道を選ぶ
